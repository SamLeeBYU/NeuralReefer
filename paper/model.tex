...
\node (img) [left=2cm of asv] {\includegraphics[width=3cm]{fig4a.jpg}};
...
\node (augimg) [below=1cm of augment] {\includegraphics[width=3cm]{fig4b.png}};
...
% Mask crops (N ~ 200)
\node (crop1) [above=2.25cm of cropcenter] {\includegraphics[width=1.4cm]{fig4c.png}};
\node (crop2) [below=0.05cm of crop1] {\includegraphics[width=1.4cm]{fig4d.png}};
\node (dots)  [below=0.05cm of crop2] {\Large$\vdots$};
\node (crop3) [below=0.05cm of dots] {\includegraphics[width=1.4cm]{fig4e.png}};
\node (crop4) [below=0.05cm of crop3] {\includegraphics[width=1.4cm]{fig4f.png}};
...
\node (maskaug) [right=2cm of vectorcenter, redbox, align=center] {Mask\\\revdel{Augmentation}\revadd{Preprocessing}};
\coordinate (augcenter) at ($(maskaug.east) + (2cm,0cm)$);

\node (aug1) [above=2.125cm of augcenter] {\includegraphics[width=1.4cm]{fig4g.png}};
\node (aug2) [below=0.05cm of aug1] {\includegraphics[width=1.4cm]{fig4h.png}};
\node (augdots) [below=0.05cm of aug2] {\Large$\vdots$};
\node (aug3) [below=0.05cm of augdots] {\includegraphics[width=1.4cm]{fig4i.png}};
\node (aug4) [below=0.05cm of aug3] {\includegraphics[width=1.4cm]{fig4j.png}};
...
% For each CNN submodel structure
...
\foreach \j/\shift in {1/0.2, 2/0.15} {
    \foreach \k in {0,1,2,3,4} { % 3 stacked vectors per FC node
        \foreach \i in {1,...,17} {
...
\foreach \j in {0,1,2, 3,4} { % 3 stacked vectors
...
% ====== LOGIT VECTOR AND ENSEMBLE MODEL ======
...
% Segmentation map node
\node (segmap) [left=1.5cm of consolidation, yshift=-3.5cm] {\includegraphics[width=5cm]{fig4k.png}};
...
\node (newdata) [right=2.5cm of stats, align=center] {
    \begin{tikzpicture}[scale=1.5, baseline=-1.5ex]
        ...
        \node[above, yshift=2mm] at (0,0.2) {New Data}; % Positioned above icon
    \end{tikzpicture}
};
